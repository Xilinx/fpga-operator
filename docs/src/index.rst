...
However, configuring and managing nodes with these hardwares requires the configuration of multiple software components such as XRT, container runtime, and device plugin.
